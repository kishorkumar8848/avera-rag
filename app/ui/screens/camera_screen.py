...
class CameraScreen(QWidget if HAS_QT else object):
    ...
    def _stop_and_process(self):
        ...
        p_dict = self.active_patient.to_dict() if self.active_patient else {}
        if hasattr(self, "active_vitals") and self.active_vitals:
            p_dict["vitals"] = self.active_vitals.to_clinical_dict() if hasattr(self.active_vitals, "to_clinical_dict") else self.active_vitals
    ...
    def _render_results(self, res: Dict[str, Any]):
        ...
        # 1. Recorded Patient Vital Signs Card (Hardware Sensors)
        ...
        if vitals_dict:
            ...
            self.guidance_layout.addWidget(v_frame)

        # 2. Main Guidance Card
        frame = QFrame()
    ...
    def _print_clinical_slip(self):
        ...
        if hasattr(self, "active_vitals") and self.active_vitals and hasattr(self.active_vitals, "to_clinical_dict"):
            p_data["vitals"] = self.active_vitals.to_clinical_dict()
