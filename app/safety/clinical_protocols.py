...
MAJOR_CLINICAL_PROTOCOLS: List[ClinicalProtocol] = [
    ...
    ClinicalProtocol(
        ...
        keywords=[
            ...
            "बुखार", "तेज बुखार", "ताप", "थरथरी", "बदन तपना", "बुकार", "तेज बुकार", "ठंड और बुखार", "बुखार और ठंड",
    ...
    ClinicalProtocol(
        ...
        keywords=[
            ...
            "जुकाम", "खांसी", "गले में दर्द", "नाक बहना", "छींक", "बलगम", "गला खराब", "खारसी", "खासी", "जुखाम", "बुझुकाम", "कफ", "खांसी और जुकाम", "जुकाम और खांसी",
    ...
    ClinicalProtocol(
        ...
        keywords=[
            ...
            "दस्त", "उल्टी", "पतले दस्त", "पानी जैसे दस्त", "मरोड़", "निर्जलीकरण", "उलटी", "उल्टी और दस्त", "दस्त और उल्टी", "पेट खराब", "लूज मोशन",
